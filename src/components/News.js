...
const News = (props) => {
  ...
  useEffect(() => {
    document.title = `${capitalizeFirstLetter(props.category)} - NewsPixar`;
    updateNews();
  ...
  return (
    <>
      <h2 className="text-center" style={{ margin: "40px", marginTop: "90px" }}>News Pixar - Top {capitalizeFirstLetter(props.category)} Headlines</h2>
      {loading && <Spin />}
      <InfiniteScroll
